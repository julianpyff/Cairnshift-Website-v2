export const Section = (): JSX.Element => {
  return (
    <div className="flex flex-col items-start p-4 relative self-stretch w-full flex-[0_0_auto] bg-[#ffffff]">
      <div className="flex flex-col max-w-[1620px] h-[660px] items-center justify-center gap-12 relative w-full rounded-2xl overflow-hidden bg-[linear-gradient(0deg,rgba(0,0,0,0.3)_0%,rgba(0,0,0,0.3)_100%),url(https://c.animaapp.com/ml3r5025flOZYU/img/container.png)_50%_50%_/_cover] opacity-[0.77]">
          ...
          <div className="relative flex-[0_0_auto] inline-flex items-start">
            <div className="inline-flex items-center justify-center gap-2.5 p-3.5 relative flex-[0_0_auto] bg-[#ffffff] rounded-[48px]">
              <img
                ...
                alt="Arrow forward"
                src="https://c.animaapp.com/ml3r5025flOZYU/img/arrow-forward-1.svg"
              />
            </div>
          </div>
        </div>
