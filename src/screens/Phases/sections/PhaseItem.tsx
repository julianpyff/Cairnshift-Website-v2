...
export const PhaseItem = ({
    ...
    return (
        <div className={`w-full flex flex-col items-center relative flex-[0_0_auto] bg-[#ffffff] ${className}`}>
            ...
            {/* Collapsible Content - No overflow-hidden to allow sticky */}
            {isOpen && (
                <div ref={contentRef} className="flex flex-col items-center w-full pt-10 pb-14 bg-[#ffffff] transition-opacity duration-500 ease-in-out opacity-100">
