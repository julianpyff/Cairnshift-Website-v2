        ...
        <div className="absolute top-0 left-[786px] w-[546px] h-[154px]">
          <div className="flex flex-col w-[calc(100%_-_353px)] items-start gap-5 pl-5 pr-0 py-0 absolute top-px left-0 border-l [border-left-style:solid] border-[#ffffff33]">
            <div className="flex flex-col w-[232px] items-start relative flex-[0_0_auto] mr-[-60.00px]">
              <div className="flex items-center justify-center [font-family:'DM_Mono',Helvetica] text-[#ee9d2b] text-right leading-[14px] relative w-fit mt-[-1.00px] font-medium text-base tracking-[0] whitespace-nowrap">
                THE ENGINES
              </div>
            </div>

            <div className="flex flex-col gap-2 self-stretch w-full items-start relative flex-[0_0_auto]">
              <div className="relative flex items-center justify-center self-stretch mt-[-1.00px] font-normal text-[#f3f3f3] leading-[23.0px] [font-family:'DM_Sans',Helvetica] text-base tracking-[0]">
                Knowledge
              </div>
